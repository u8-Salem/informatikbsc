 ...
 * insertElement.
 *
 *  \param list The list into which the pid-cmd pair should be inserted.
 ...
 */
int insertElement(list *list, pid_t pid, const char *commandLine);
 ...
 */
int removeElement(list *list, pid_t pid, char *commandLineBuffer, size_t bufferSize);
 ...
 * 	process list.
 *
 *  \param list The list to walk over.
